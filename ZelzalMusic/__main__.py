...
async def init():
    ...
    LOGGER("ميــوزك دارك").info("تم تحميل الاضافات ...✓")
    await userbot.start()
    await Zelzaly.start()
    try:
        await Zelzaly.stream_call("https://telegra.ph/file/b3e5093cb07c6185cd3fc.jpg")
    except NoActiveGroupCall:
        LOGGER("ميــوزك دارك").info(
    ...
    await app.stop()
    await userbot.stop()
    LOGGER("ميــوزك دارك").info("جارِ ايقاف بوت الميوزك . . .")
